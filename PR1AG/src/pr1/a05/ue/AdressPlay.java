...
public class AdressPlay {
	...
	public static ArrayList<Adresse> createTestAdresses() {
		...
		ArrayList<Adresse> aList2 = new ArrayList<Adresse>();
		aList2.add(adresse1);
		aList2.add(adresse2);
		aList2.add(adresse3);
		aList2.add(adresse4);
	...
	public static void someInhabitants() {
        ...
        ArrayList<Adresse> aList = new ArrayList<Adresse>(createTestAdresses());
	...
	public static ArrayList<Adresse> createAdressen (Scanner in) {
		ArrayList<Adresse> aList = new ArrayList<Adresse>();
		while (in.hasNext()) {
	...
	public static ArrayList<Adresse> createAdressen (String filename) {
		 ...
		 ArrayList<Adresse> aList = createAdressen(in);
		 in.close();
		 return aList;
	}
}
